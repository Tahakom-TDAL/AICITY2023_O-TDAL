...
# Path to the checkpoint to load the initial weight.
_C.TEST.CHECKPOINT_FILE_PATH = "checkpoints/checkpoint_epoch_00840.pyth"
...
# The path to the data directory.
_C.DATA.SAVE_PATH_FOR_FEATURE_AND_PROBABILITY = ""
...
# Output basedir.
_C.OUTPUT_DIR = "results/checkpoint_epoch_00610"
...
# Default to to cfg.OUTPUT_DIR/runs-{cfg.TRAIN.DATASET}. ./stdout.log
_C.TENSORBOARD.LOG_DIR = ""
# Path to a json file providing class_name - id mapping
# in the format {"class_name1": id1, "class_name2": id2, ...}.
# This file must be provided to enable plotting confusion matrix
# by a subset or parent categories.
_C.TENSORBOARD.CLASS_NAMES_PATH = "Dataset/class_names.json"
...
_C.TENSORBOARD.CONFUSION_MATRIX.FIGSIZE = [11, 11]
...
_C.TENSORBOARD.HISTOGRAM.FIGSIZE = [11, 11]
